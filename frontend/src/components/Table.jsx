            ...
            <div className="flex flex-col">
                <div className="overflow-x-auto shadow-md sm:rounded-lg">
                    <div className="inline-block min-w-full align-middle">
                        <div className="">
                            <table className="min-w-full divide-y-2 divide-gray-300 dark:divide-gray-100/50 table-fixed">
                                ...
                                {data ?
                                    <tbody className="bg-white dark:bg-zinc-800/75 dark:text-white/80 text-black/50 text-sm">
                                        {data.map((context) => {
                                            return (
                                                <tr key={context.id} className="border-t border-gray-100 dark:border-gray-100/50">
                                                    ...
                                                    <td className="py-4 px-6 font-medium whitespace-nowrap">
                                                        <a href={`/History/Test?id=${context.id}`} className="text-green-600 dark:text-green-500 hover:bg-green-300 bg-green-100 dark:bg-green-400 dark:text-green-800 rounded-full pt-1 pb-1 pl-3 pr-3">View</a>
                                                    </td>
                                                </tr>
                                            )
                                        })}
